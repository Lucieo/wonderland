import { CendrillonScroll, PantoufleSvg } from 'animations/cendrillon'
import { Book, ParagraphTypes, Position } from 'data/types'

export const CENDRILLON: Book = {
  slug: 'cendrillon',
  color: 'red',
  title: 'Cendrillon',
  homeAnimation: PantoufleSvg,
  author: 'Les frères Grimm',
  mainImage: '',
  abstract: "Cendrillon, une douce jeune fille, subit les méchancetés de sa belle-mère et de ses deux horribles filles. Un jour, transformée par sa marraine la bonne fée en princesse éclatante de beauté, elle se rend au bal du prince qui tombe fou amoureux d'elle...",
  chapters: [
    {
      illustration: 'chapter1.jpeg',
      title: 'Chapitre Premier',
      subtitle: 'Pauvre Cendrillon',
      pages: [
        {
          paragraphs: [
            {
        ...
        },
        {
          paragraphs: [
            ...
            {
              content:
                'Mais elle était bonne, et elle les coiffa parfaitement bien. Elles furent près de deux jours sans manger, tant elles étaient transportées de joie. On rompit plus de douze lacets, à force de les serrer pour leur rendre la taille plus menue, et elles étaient toujours devant le miroir. Enfin l’heureux jour arriva ; on partit, et Cendrillon les suivit des yeux, le plus longtemps qu’elle put.',
            },
          ],
        },
      ],
    ...
    {
      illustration: 'chapter2.jpeg',
      title: 'Deuxième Chapitre',
      subtitle: 'Un peu de magie',
      pages: [
        {
          paragraphs: [
            {
    ...
    {
      illustration: 'chapter3.jpeg',
      title: 'Troisième Chapitre',
      subtitle: 'Les bals du château',
      pages: [
        {
          paragraphs: [
            {
    ...
    {
      illustration: 'chapter4.jpeg',
      title: 'Quatrième Chapitre',
      subtitle: 'La mystérieuse inconnue',
      pages: [
        {
          paragraphs: [
            {
            ...
            {
              content:
                'Elles dirent vrai ; car, peu de jours après, le fils du roi fit publier, à son de trompe, qu’il épouserait celle dont le pied serait bien juste à la pantoufle. On commença à l’essayer aux princesses, ensuite aux duchesses et à toute la cour, mais inutilement.',
            },
          ],
        },
        {
          paragraphs: [
            {
              content:
                "On l’apporta chez les deux sœurs, qui se réjouirent car elles avaient le pied joli. L'aînée fit tout son possible pour faire entrer son pied dans la pantoufle, mais elle ne pu en venir à bout. La cadette alla dans sa chambre pour essayer le soulier en compagnie de sa mère. Mais elle ne put y faire entrer le gros orteil, car la chaussure était trop petite pour elle.",
            },
            {
              content:
                "Sa mère lui tendit un couteau en lui disant : - Coupe-toi ce doigt; quand tu seras reine, tu n’auras plus besoin d'aller à pied. Alors la jeune fille se coupa l'orteil, fit entrer de force son pied dans le soulier et, contenant sa douleur, s'en alla trouver le fils du roi. Mais il regarda le pied et vit que le sang en coulait, et dit que ce n'était pas la véritable jeune fille.",
              type: ParagraphTypes.CENSORED,
            },
          ],
        },
        {
          paragraphs: [
            {
              content:
                'Cendrillon, qui les regardait, et qui reconnut sa pantoufle, dit : « Que je voie si elle ne me serait pas bonne ! » Ses sœurs se mirent à rire et à se moquer d’elle.',
            },
            {
              content:
            ...
            {
              content:
                'L’étonnement des deux sœurs fut grand, mais plus grand encore quand Cendrillon tira de sa poche l’autre petite pantoufle, qu’elle mit à son pied. Là-dessus arriva la marraine, qui, ayant donné un coup de baguette sur les habits de Cendrillon, les fit devenir encore plus magnifiques que tous les autres.',
            },
          ],
        },
        {
          paragraphs: [
            {
              content:
                'Alors ses deux sœurs la reconnurent pour la personne qu’elles avaient vue au bal. Elles se jetèrent à ses pieds pour lui demander pardon de tous les mauvais traitements qu’elles lui avaient fait souffrir. Cendrillon les releva et leur dit, en les embrassant, qu’elle leur pardonnait de bon cœur, et qu’elle les priait de l’aimer bien toujours.',
            },
            {
              content:
                'On la mena chez le jeune prince, parée comme elle était, et, peu de jours après, il l’épousa. Cendrillon, qui était bonne, fit loger ses deux sœurs au palais, et les maria, dès le jour même, à deux grands seigneurs de la cour.',
            },
          ],
        },
      ],
